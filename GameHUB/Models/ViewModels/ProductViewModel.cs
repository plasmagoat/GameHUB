...
{
    public class ProductViewModel<TProduct> : IViewModel<TProduct> where TProduct : ProductContent
    {
        public ProductViewModel(TProduct product)
        {
        ...
        public TProduct CurrentContent { get; }
    ...
    public static class ProductViewModel
    {
        ...
        public static ProductViewModel<TProduct> Create<TProduct>(TProduct product) where TProduct : ProductContent
        {
            var viewModel = new ProductViewModel<TProduct>(product);
